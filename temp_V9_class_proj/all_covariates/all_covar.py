...
import os
import json
model_params_dir = "/scratch/users/jelazaro/temp_V9_results/model_params/xgbd_all_cov"
model_type = "xgbd_all_cov"
...
prev_yr_lags = [12]
lagged_vars = ['wind_speed', 'dewpoint_temperature',
       'hi_veg_cover', 'leaf_area_index_hi_veg', 'leaf_area_index_lo_veg',
       'low_veg_cover', 'potential_evaporation', 'runoff',
       'skin_reservoir_content', 'soil_temperature_layer_1',
       'surface_pressure', 'surface_runoff', 'precipitation',
       'volumetric_soil_water_layer_1', 'relative_humidity',
       'vapor_pressure_diff']
...
fit_vars = ['temperature_L1',
       'temperature_L2', 'temperature_L3', 'temperature_L4', 'temperature_L5',
       'temperature_L6', 'temperature_L7', 'temperature_L8', 'temperature_L9',
       'temperature_L10', 'temperature_L11', 'temperature_L12',
       'temperature_L24', 'temperature_L36', 'wind_speed_L12',
       'dewpoint_temperature_L12', 'hi_veg_cover_L12',
       'leaf_area_index_hi_veg_L12', 'leaf_area_index_lo_veg_L12',
       'low_veg_cover_L12', 'potential_evaporation_L12', 'runoff_L12',
       'skin_reservoir_content_L12', 'soil_temperature_layer_1_L12',
       'surface_pressure_L12', 'surface_runoff_L12', 'precipitation_L12',
       'volumetric_soil_water_layer_1_L12', 'relative_humidity_L12',
       'vapor_pressure_diff_L12']
    ...
    for max_depth in [3, 5, 7, 9]:
        for gamma in [0, 0.05, 0.1, 0.15, 0.2]:
            for min_child_weight in [1, 3, 5]:
                for reg_alpha in [0, 0.001, 0.01, 0.1, 1, 10]:
...
xgbd_model = XGBDistribution(
    ...
    reg_alpha = best_model[2016].reg_alpha
)
...
params_filename = os.path.join(model_params_dir, f"{county_name}_{model_type}_params.txt")

# Write the parameters to the file in JSON format
...
quantile_scores_df.to_csv(f"/scratch/users/jelazaro/temp_V9_results/all_covar/quantile_scores/{county_name}_QS_OG_lags.csv")
all_simulation_results_df.to_csv(f"/scratch/users/jelazaro/temp_V9_results/all_covar/simulation_values/{county_name}_simulation_values_OG_lags.csv")
all_feature_importance_df.to_csv(f"/scratch/users/jelazaro/temp_V9_results/all_covar/ft_importance/{county_name}_ft_importance_OG_lags")
