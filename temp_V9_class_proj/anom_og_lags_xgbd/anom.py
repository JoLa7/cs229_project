...
county_data = data[data["county"] == county_name] # recall that the data needs to be full to subset data 
...
quantile_scores_df.to_csv(f"/scratch/users/jelazaro/temp_V9_results/anom_og_lags_xgbd/quantile_scores/{county_name}_QS_anom_lags.csv")
all_simulation_results_df.to_csv(f"/scratch/users/jelazaro/temp_V9_results/anom_og_lags_xgbd/simulation_values/{county_name}_simulation_values_anom_lags.csv")
all_feature_importance_df.to_csv(f"/scratch/users/jelazaro/temp_V9_results/anom_og_lags_xgbd/ft_importance/{county_name}_ft_importance_anom_lags")
